...
async def delete_document(
    ...
    Removes the document record from the database and, if the associated file
    exists on disk, removes it as well.
    ...
    # Remove the physical file if it still exists on disk (gracefully skip if missing)
