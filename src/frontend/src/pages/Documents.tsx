...
export const Documents = () => {
    ...
    // deleteTarget holds the document the user wants to delete
    ...
    // User confirmed — call the API and update the list
    ...
    return (
        <>
            ...
            {/* Delete Confirmation Modal — rendered outside the scroll container
                so it always overlays the full viewport.                          */}
            {deleteTarget && (
