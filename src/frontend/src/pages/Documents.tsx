            ...
            {deleteTarget && (
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    ...
                    <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 p-6">
                        ...
                        <p className="text-gray-700 font-medium text-center text-sm mb-6 truncate px-4">
                            "{deleteTarget.name}"
                        </p>
                        <p className="text-rose-500 text-center text-xs mb-6">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                disabled={deleting}
                                className="flex-1 px-4 py-2.5 rounded-lg bg-rose-600 text-white font-medium hover:bg-rose-700 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
                            >
                                {deleting ? (
                                    <>
