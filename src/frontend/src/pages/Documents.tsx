...
export const Documents = () => {
    ...
    // deleteTarget: the document the user clicked "Delete" on; null = modal closed
    ...
    // User confirmed — call DELETE endpoint then remove from local state
                ...
                >
                    ...
                    >
                        ...
                        <div className="px-6 py-5">
                            ...
                            {/* Document preview — filename is inside a <tr> for test locator compatibility */}
